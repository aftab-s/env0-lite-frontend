...
;
const session = async (param)=>{
    let { session, token } = param;
    session.user.id = token.id;
    return session;
};
const getUserSession = async ()=>{
    const authUserSession = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getServerSession"])({
        callbacks: {
            session
        }
    });
    // if (!authUserSession) throw new Error('unauthorized')
    return authUserSession === null || authUserSession === void 0 ? void 0 : authUserSession.user;
};
...
async function AuthForm() {
    ...
    const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$session$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserSession"])();
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$query$2f$useAuthentication$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signIn"])({
                email,
                password
            });
        } catch (error) {
...
_s(AuthForm, "RUz19ZpuYKJ+4Hu01ENB4zoUS3U=");
_c = AuthForm;
var _c;
...
//# sourceMappingURL=src_59c345c7._.js.map