...
function AuthForm() {
    _s();
    const { data: session } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSession"])(); // ✅ works now that SessionProvider is added
    ...
    const handleSubmit = async (e)=>{
        ...
        setErrors({});
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$query$2f$useAuthentication$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logIn"])({
                email,
                password
            });
        } catch (error) {
...
_s(AuthForm, "8vWIaXQghC88kdEhJZDpNmzBTZg=", false, function() {
    return [
...
//# sourceMappingURL=src_b5eb5e39._.js.map